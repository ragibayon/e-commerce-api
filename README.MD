...
[E-Commerce API Render URL](https://ecommerce-api-ragib.onrender.com)
...
- [x] verify jwt - jwt.verify(token,secret) should be in auth middleware
...
- [x] send back the same response as in register
